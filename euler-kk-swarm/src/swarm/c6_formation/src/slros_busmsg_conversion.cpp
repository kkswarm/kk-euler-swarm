...
// Conversions between SL_Bus_kkswarm_msgs_KKSwarmState and kkswarm_msgs::msg::KKSwarmState

void convertFromBus(kkswarm_msgs::msg::KKSwarmState& msgPtr, SL_Bus_kkswarm_msgs_KKSwarmState const* busPtr)
{
  const std::string rosMessageType("kkswarm_msgs/KKSwarmState");

  msgPtr.acc_x =  busPtr->acc_x;
  msgPtr.acc_y =  busPtr->acc_y;
  msgPtr.angular_speed =  busPtr->angular_speed;
  msgPtr.gyro_z =  busPtr->gyro_z;
  convertFromBus(msgPtr.header, &busPtr->header);
  msgPtr.left_encoder =  busPtr->left_encoder;
  msgPtr.linear_speed =  busPtr->linear_speed;
  msgPtr.mark =  busPtr->mark;
  msgPtr.right_encoder =  busPtr->right_encoder;
  msgPtr.socketfd =  busPtr->socketfd;
  msgPtr.voltage =  busPtr->voltage;
}

void convertToBus(SL_Bus_kkswarm_msgs_KKSwarmState* busPtr, const kkswarm_msgs::msg::KKSwarmState& msgPtr)
{
  const std::string rosMessageType("kkswarm_msgs/KKSwarmState");

  busPtr->acc_x =  msgPtr.acc_x;
  busPtr->acc_y =  msgPtr.acc_y;
  busPtr->angular_speed =  msgPtr.angular_speed;
  busPtr->gyro_z =  msgPtr.gyro_z;
  convertToBus(&busPtr->header, msgPtr.header);
  busPtr->left_encoder =  msgPtr.left_encoder;
  busPtr->linear_speed =  msgPtr.linear_speed;
  busPtr->mark =  msgPtr.mark;
  busPtr->right_encoder =  msgPtr.right_encoder;
  busPtr->socketfd =  msgPtr.socketfd;
